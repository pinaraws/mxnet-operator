...
${CODEGEN_PKG}/generate-groups.sh "defaulter,deepcopy,client,informer,lister" \
 github.com/pinaraws/mxnet-operator/pkg/client github.com/pinaraws/mxnet-operator/pkg/apis \
 mxnet:v1beta1 \
 --go-header-file hack/boilerplate/boilerplate.go.txt

# Notice: The code in code-generator does not generate defaulter by default.
echo "Generating defaulters for v1beta1"
${GOPATH}/bin/defaulter-gen  --input-dirs github.com/pinaraws/mxnet-operator/pkg/apis/mxnet/v1beta1 \
  -O zz_generated.defaults \
  --go-header-file hack/boilerplate/boilerplate.go.txt \
  --output-package github.com/pinaraws/mxnet-operator/pkg/apis/mxnet/v1beta1
